...
This test will verify that the BeamEscrow Canister is not vulnerable to reentrancy attack with multiple claims at the same time. It is relatively sophisticated test and requires a bit of understanding of the BeamFi protocol, Internet Computer and dfx cmd.
